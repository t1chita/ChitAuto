...
final class LocationCell: UITableViewCell {
    ...
    private let locationName: GeneralLabel = {
    ...
    //MARK: - Configure
    func configure(withLocation locationName: String) {
    ...
    private func setReleaseDate() {
        rectangleView.addSubview(locationName)
        
        NSLayoutConstraint.activate([
            locationName.centerYAnchor.constraint(equalTo: rectangleView.centerYAnchor),
            locationName.heightAnchor.constraint(equalToConstant: 17),
            locationName.trailingAnchor.constraint(equalTo: rectangleView.trailingAnchor, constant: -34),
        ])
    }
}
